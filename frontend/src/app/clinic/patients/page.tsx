        ...
        switch (step) {
            ...
            case 5: return (
                <div className="space-y-6">
                    ...
                    <div>
                        <label className={`flex items-start gap-3 cursor-pointer p-4 rounded-lg border-2 ${formErrors.dpdpConsent ? 'border-red-500 bg-red-50' : formData.dpdpConsent ? 'border-primary-500 bg-primary-50' : 'border-gray-200'}`}>
                            <input type="checkbox" className="mt-1 w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                                checked={formData.dpdpConsent} onChange={e => set('dpdpConsent', e.target.checked)} />
                            <div>
                                <span className="text-sm font-medium text-gray-900">DPDP Act 2023 Consent <span className="text-red-500">*</span></span>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {loading ? (
                                ...
                                <tr key={p.id} className="hover:bg-gray-50 transition-colors cursor-pointer group"
                                    onClick={() => router.push(`/clinic/patients/${p.id}`)}>
